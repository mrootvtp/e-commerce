        ...
        <div class="container-fluid fruite py-5">
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    ...
                                                    <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart-btn" data-id='{{$product->id}}'><i class="fa fa-shopping-bag me-2 text-primary" ></i> Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="pagination d-flex justify-content-center mt-5">
                ...
                @foreach ($products->getUrlRange(1, $products->lastPage()) as $page => $url)
                    <a href="{{ $url }}" class="rounded {{ $products->currentPage() == $page ? 'active' : '' }}">
                        {{ $page }}
                    </a>
                @endforeach
